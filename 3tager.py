                ...
                if msg.text in ["Tag","tagall","แทค","แทก","Tagall","tag"]:
                    ...
                    for a in range(k+1):
                        ...
                        for i in group.members[a*20 : (a+1)*20]:
                            ...
                            s += 7
                            txt += u'@Alin \n'
                        nadya.sendReplyMessage(msg.id, msg.to, text=txt, contentMetadata={u'MENTION': json.dumps({'MENTIONEES':b})}, contentType=0)
                        nadya.sendReplyMessage(msg.id, msg.to, "จำนวนสมาชิก {} คน(。-`ω´-)".format(str(len(nama))))
#==============================================================================#
