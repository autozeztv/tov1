...
#==============================================================================#
                ...
                if "ทีมงาน" == msg.text.lower():
                    ...
                    nadya.sendContact(to, "u740dc5b30c38810eadb7251ecd3b40b6")
                    nadya.sendContact(to, "ud9a8574da99811f0e378af4587afd54c")
                    nadya.sendContact(to, "u599cda6f2e38ead912b0c4222685a4a2")
                ...
                if msg.text in ["คท",".คท","Me","me",".Me",".me"]:
                    ...
                    nadya.sendMessageMusic(msg.to, sender) 
                ...
                if msg.text in ["/token"]:
                  if msg._from in admin:
                      nadya.sendMessage(msg.to,nadya.authToken)
