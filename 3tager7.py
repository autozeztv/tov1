...
def waktu(secs):
	...
	return '%02d วัน %02d ชั่วโมง %02d นาที %02d วินาที (。-`ω´-)' % (days, hours, mins, secs)
    ...
    try:
        ...
        if op.type == 13:
            ...
            if settings["autoJoin"] == True:
                ...
                nadya.sendMessage(op.param1, settings["JoinMessage"])
                ...
                if msg.text in ["Tag","tagall","แทค","แทก","Tagall","tag"]:
                    ...
                    if msg.toType == 1:
                        ...
                        members = [mem.mid for mem in room.contacts]
                          ...
                          return nadya.sendReplyMessage(msg.id, msg.to, '「 แทค 」 • เกิดข้อผิดพลาด')
                    if members:
...
#==============================================================================#
                if text.lower() == 'เปิดอ่าน':
                    ...
                    bulan = ["มกราคม", "กุมภาพันธ์", "เดือนมีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"]
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                nadya.sendReplyMessage(msg.id, msg.to, "เปิดอ่าน(。-`ω´-)")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
            ...
            if msg.contentType == 7:
                if settings["checkSticker"] == True:
                    ...
                    ret_ = "╭────ข้อมูลติ้ก─────"
                    ret_ += "\n├ ไอดีสติ้กเกอร์ : {}".format(stk_id)
                    ret_ += "\n├ รหัสไอดีสติ้กเกอร์ : {}".format(pkg_id)
                    ret_ += "\n├ การส่งของสติ้กเกอร์ : {}".format(stk_ver)
                    ret_ += "\n├ ลิ้งสติ้กเกอร์ : line://shop/detail/{}".format(pkg_id)
                    ret_ += "\n╰──────────"
