...
#==============================================================================# 
                ...
                if text.lower() == 'เวลา':
                    ...
                    nadya.sendReplyMessage(msg.id, msg.to, "╭──「 เช็คเวลา 」\n├ {}\n╰────────────".format(readTime))
#==============================================================================#
                if text.lower() == '.ลบรัน':
                  if msg._from in admin:
...
#=================THEFLASH====================================================#
                ...
                if msg.text.lower() == ".ตั้งติ๊กเข้า":
                 if msg._from in admin:
                    ...
                    nadya.sendMessage(to, "ส่งสติกเกอรที่จะตั้งลงมา")
                if msg.text.lower() == ".ลบติ๊กเข้า":
                 if msg._from in admin:
                    settings["messageSticker"]["listSticker"]["welcomeSticker"] = None
                    nadya.sendMessage(to, "ลบสติกเกอรคนเข้าแล้ว")

                if text.lower() == '.ยกเลิก on':
                  if msg._from in admin:
                      settings["unsend"] = True
                      nadya.sendMessage(to, "เปิดเช็คยกเลิกข้อความแล้ว(。-`ω´-)")
                if text.lower() == '.ยกเลิก off':
                  if msg._from in admin:
                      settings["unsend"] = False
                      nadya.sendMessage(to, "ปิดเช็คยกเลิกข้อความแล้ว(。-`ω´-)") 
...
#==============================================================================#
            ...
            if msg.contentType == 7:
                ...
                if settings["addSticker"]["status"] == True:
                    ...
                    nadya.sendMessage(to, "Success Added sticker {}".format(str(settings["addSticker"]["name"])))
