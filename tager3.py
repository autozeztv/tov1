    ...
    try:
        ...
        if op.type == 13:
            ...
            if settings["autoJoin"] == True:
                ...
                nadya.sendMessage(op.param1, " {} ขอบคุณที่เชิญเข้ากลุ่มครับ(。-`ω´-)".format(str(nadya.getContact(op.param1).displayName)))
...
#==============================================================================#
                ...
                if "ทีมงาน" == msg.text.lower():
                    ...
                    nadya.sendContact(to, "u1e295dacdacf4011811def710cd1750c")
                ...
                if msg.text in ["คท",".คท","Me","me",".Me",".me"]:
                      nadya.sendMentionFooter(to, '「 MY SELF 」\n•', sender, "https://line.me/ti/p/~hietocih", "http://dl.profile.line-cdn.net/"+nadya.getContact(sender).pictureStatus, nadya.getContact(sender).displayName);nadya.sendMessage(to, nadya.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+nadya.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~hietocih', 'type': 'mt', 'subText': "BOT THE FLASH", 'a-installUrl': 'https://line.me/ti/p/~hietocih', 'a-installUrl': ' https://line.me/ti/p/~hietocih', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~hietocih', 'i-linkUri': 'https://line.me/ti/p/~hietocih', 'id': 'mt000000000a6b79f9', 'text': 'THEFLASH', 'linkUri': 'https://line.me/ti/p/~hietocih'}, contentType=19)

                if msg.text in ["ไอดี","MID","mid","Mid",".mid",".MID"]:
                	you = nadya.getContact(sender)
                	nadya.sendMentionFooter(to, '「 MY ID 」\n•', you.nadyaMID, "https://line.me/ti/p/~hietocih", "http://dl.profile.line-cdn.net/"+nadya.getContact(sender).pictureStatus, nadya.getContact(sender).displayName);nadya.sendMessage(to, nadya.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+nadya.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~hietocih', 'type': 'mt', 'subText': "BOT THE FLASH", 'a-installUrl': 'https://line.me/ti/p/~hietocih', 'a-installUrl': ' https://line.me/ti/p/~hietocih', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~hietocih', 'i-linkUri': 'https://line.me/ti/p/~hietocih', 'id': 'mt000000000a6b79f9', 'text': 'THEFLASH', 'linkUri': 'https://line.me/ti/p/~hietocih'}, contentType=19)

                if msg.text in ["ชื่อ","เนม",".เนม","Name",".Name","name",".name"]:
                    you = nadya.getContact(sender)
                    nadya.sendMentionFooter(to, '「 MY NAME 」\n•', you.displayName, "https://line.me/ti/p/~hietocih", "http://dl.profile.line-cdn.net/"+nadya.getContact(sender).pictureStatus, nadya.getContact(sender).displayName);nadya.sendMessage(to, nadya.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+nadya.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~hietocih', 'type': 'mt', 'subText': "BOT THE FLASH", 'a-installUrl': 'https://line.me/ti/p/~hietocih', 'a-installUrl': ' https://line.me/ti/p/~hietocih', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~hietocih', 'i-linkUri': 'https://line.me/ti/p/~hietocih', 'id': 'mt000000000a6b79f9', 'text': 'THEFLASH', 'linkUri': 'https://line.me/ti/p/~hietocih'}, contentType=19)

                if msg.text in ["สถานะ","ตัส"]:
                    you = nadya.getContact(sender)
                    nadya.sendMentionFooter(to, '「 MY STATUS 」\n•', you.statusMessage, "https://line.me/ti/p/~hietocih", "http://dl.profile.line-cdn.net/"+nadya.getContact(sender).pictureStatus, nadya.getContact(sender).displayName);nadya.sendMessage(to, nadya.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+nadya.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~hietocih', 'type': 'mt', 'subText': "BOT THE FLASH", 'a-installUrl': 'https://line.me/ti/p/~hietocih', 'a-installUrl': ' https://line.me/ti/p/~hietocih', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~hietocih', 'i-linkUri': 'https://line.me/ti/p/~hietocih', 'id': 'mt000000000a6b79f9', 'text': 'THEFLASH', 'linkUri': 'https://line.me/ti/p/~hietocih'}, contentType=19)

                elif text.lower() == 'รูป':
                    you = nadya.getContact(sender)
                    nadya.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + you.pictureStatus)
