...
Rfu = [nadya]
RfuBot=[nadyaMID]
admin=['uad73a8119f2accea9e8f39e39291ac9a','ue9781edcd4eecd9abfd6e50fc3ea95b1','u740dc5b30c38810eadb7251ecd3b40b6 ','ud9a8574da99811f0e378af4587afd54c','u599cda6f2e38ead912b0c4222685a4a2',nadyaMID]
Family=["uad73a8119f2accea9e8f39e39291ac9a","ue9781edcd4eecd9abfd6e50fc3ea95b1","u740dc5b30c38810eadb7251ecd3b40b6","ud9a8574da99811f0e378af4587afd54c","u599cda6f2e38ead912b0c4222685a4a2"nadyaMID]
...
#==============================================================================#
                ...
                if "ทีมงาน" == msg.text.lower():
                    msg.contentType = 13
                    nadya.sendReplyMessage(msg.id, msg.to, "✍️  ᴛ⃢​ᴇ⃢​ᴀ⃢​ᴍ⃢   🔝ͲᎻᎬᖴ͙͛Ꮮ͙͛ᗩ͙͛ᔑ͙͛Ꮋ͙  ̾⚡")
                ...
                if text.lower() == 'อ่าน':
                    ...
                    if receiver in read['readPoint']:
                        if read["ROM"][receiver].items() == []:
                            nadya.sendReplyMessage(msg.id, msg.to, receiver,"[ Reader ]:\nNone")
                        else:
                            chiya = []
                        ...
                        text = xpesan+ zxc + "\n[ Lurking time ]: \n" + readTime
                        try:
                            nadya.sendReplyMessage(msg.id, msg.to, receiver, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                        except Exception as error:
                            print (error)
                        pass
                    else:
                        nadya.sendReplyMessage(msg.id, msg.to, receiver,"ก่อนจะพิมคำสั่งนี้กรุณา (เปิดอ่าน) ก่อนลงคำสั่งนี้(。-`ω´-)")
            ...
            if msg.contentType == 1:
                ...
                if msg.toType == 2:
                        if settings["changeGroupPicture"] == True: 
                            ...
                            nadya.sendReplyMessage(msg.id, msg.to, "เปลี่ยนรูปกลุ่มสำเร็จแล้ว(。-`ω´-) ")
#==============================================================================#
        if op.type == 55:
